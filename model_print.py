...
setting0 = json2Parser('./0D/HE04_Hydrogen_ESH2_GMS_sub1_20221101/checkpoint/settings.json')
setting1 = json2Parser('./0D/HE04_Hydrogen_ESH2_GMS_sub2_20221101/checkpoint/settings.json')
setting2 = json2Parser('./0D/HE04_Hydrogen_ESH2_GMS_sub3_20221101/checkpoint/settings.json')
...
if __name__ == '__main__':
    model0 = Net()
    model0.to('cpu')
    check_point = torch.load('./0D/HE04_Hydrogen_ESH2_GMS_sub3_20221101/checkpoint/model5000.pt')
    ...
    for k, v in model_dict.items():
        ...
        save_bin(v, './0Dbin/model2/' + k + '_model2.bin')  # print(new_dict)
        # print(v)
    data2 = load_bin('./0Dbin/model2/fc.0.bias_model2.bin', 1600)
